    ...
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={handleSearch} className="mb-4 flex flex-col md:flex-row items-center justify-end space-y-2 md:space-y-0 md:space-x-2">
        <input
          ...
          className="w-full md:flex-grow border px-4 py-2 border-gray-300 rounded-2xl focus:ring-2 focus:ring-emerald-500 outline-none transition duration-200 ease-in-out"
        />
        <button
          type="submit"
